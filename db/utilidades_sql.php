...
/*function set_validar_turno_agendado(){
	global $mysqli;
	$sql ="SELECT * FROM turno, turno_agendado, agenda_cita WHERE not turno._id_turno = turno_agendado._id_turno_agendado and fecha='2016-11-17';"
	$mysqli-> query ($sql);
}*/
